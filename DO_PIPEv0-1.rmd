...
In an empty project folder, place a copy of the DO_pipe markdown and run the 'Setup Project Environment'.
...
```
The folder architecture for your project is set up.
