...
for(i in unique(intDF$sex)){
  ...
  xthresh_hi <- median(tmp$Xavg) + (3.5*mad(tmp$Xavg))
  xthresh_lo <- median(tmp$Xavg) - (3.5*mad(tmp$Xavg))
  ythresh_hi <- median(tmp$Yavg) + (3.5*mad(tmp$Yavg))
  ythresh_lo <- median(tmp$Yavg) - (3.5*mad(tmp$Yavg))
...
for(i in unique(intDF$sex)){
  ...
  xthresh_hi <- median(tmp$Xavg) + (3.5*mad(tmp$Xavg))
  xthresh_lo <- median(tmp$Xavg) - (3.5*mad(tmp$Xavg))
  phetXthresh_hi <- median(tmp$phetX) + (3.5*mad(tmp$phetX))
  phetXthresh_lo <- median(tmp$phetX) - (3.5*mad(tmp$phetX))
